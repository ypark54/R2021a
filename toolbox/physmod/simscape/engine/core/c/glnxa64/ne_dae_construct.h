...
struct NeConstraintStatTag NeConstraintStat;struct NeConstraintStatTag{void(*
...
SscIniterTag SscIniter;typedef struct NeRtpValuesTag NeRtpValues;struct
...
SscIniter*initer,boolean_T isIniter,boolean_T isScalable,NeRtpValues*rtpValues
...
compStats,CStateManager*csm,PmAllocator*allocatorPtr);
#ifdef __cplusplus
}
#endif /* __cplusplus */
